...
export function profile(
    target: object,
    key: string | symbol,
    _descriptor: TypedPropertyDescriptor<Function> | TypedPropertyDescriptor<() => void>
): void;
export function profile(
    ...
    const className = !ctor.prototype ? ctor.constructor.name : ctor.prototype.constructor.name;
